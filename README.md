...
> **Note**: Multi-pane hierarchical delegation (Master/Mid/Leaf chain pattern)은 구 Pattern B v1으로, "Family" 패턴 v2로 재설계 중. 현재 본 repo에는 chain helpers 미포함. 진행 상황은 `docs/superpowers/specs/2026-04-19-family-teammate-ux-requirements.md` 참조.
